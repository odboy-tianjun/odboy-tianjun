...
| 自研  | 容器镜像存储                                   | https://github.com/odboy-tianjun/kenaito-image-register     | Go                                                        | Pending |- 推送镜像<br/> - 拉取镜像|
| 自研  | 配置中心                                     | https://github.com/odboy-tianjun/kenaito-config             | SpringBoot2、Vue2                                          | Pending |- 初始化拉取配置<br/> - 配置中心离线读取本地配置<br/> - 更新@Value的值<br/> - 更新@ConfigurationProperties绑定的值 |
| 自研  | DNS可视化配置中心                               | https://github.com/odboy-tianjun/kenaito-dns                | Gin、Xorm、D2Admin（Vue2）                                    | Finish|使用了kubernetes coredns使用的依赖"miekg/dns"，可以去看看大佬写的优秀代码  |
| 自研 | Go快速开发脚手架，包含RBAC                         | https://github.com/odboy-tianjun/cutego                     | Gin、Xorm、自定义RBAC（非Casbin）、JWT、Redis、Vue2                  | Finish      |-|
